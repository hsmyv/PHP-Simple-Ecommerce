  <!-- FOOTER -->
    ...
    <script type="text/javascript" src="<?=ASSETS?>ecoomerce/js/responsee.js"></script>
    <script type="text/javascript" src="<?=ASSETS?>ecoomerce/js/jquery.events.touch.js"></script>
    <script type="text/javascript" src="<?=ASSETS?>ecoomerce/owl-carousel/owl.carousel.js"></script>
    <script type="text/javascript" src="<?=ASSETS?>ecoomerce/js/template-scripts.js"></script> 
  </body>
</html>