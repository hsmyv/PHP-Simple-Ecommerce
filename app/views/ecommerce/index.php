<?php $this->view("ecommerce/header", $data); ?>
      ...
      <main role="main">
        ...
        <article>
          ...
          <div class="background-white full-width"> 
            <div class="s-12 m-6 l-five">
              <a class="image-with-hover-overlay image-hover-zoom" href="<?=ROOT.'single_post/'. $post->url_address;?>" title="Portfolio Image">
                ...
                <img class="full-img" src="<?=ROOT. $post->image?>" alt=""/>
              </a>	
            </div>
            <?php endforeach; ?>
            <?php endif; ?>
        ...
        <section>
         ...
         <a href="<?=$data['next_page']?>"><input type="button" class="s-12 submit-form button background-primary text-white" style="width: 200px; float: right;" value="Prev"></a>
        </section>
      </main>
